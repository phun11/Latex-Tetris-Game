...
Lời đầu tiên, em xin gửi lời cảm ơn chân thành và sâu sắc đến thầy Nguyễn Văn Toàn – giảng viên môn Kỹ năng nghề nghiệp (SS004.6). Nhờ sự hướng dẫn tận tình và những kiến thức bổ ích thầy đã truyền đạt, em đã có thêm nhiều góc nhìn mới và hiểu biết sâu hơn về các kỹ năng cần thiết cho hành trình học tập cũng như định hướng nghề nghiệp trong tương lai.
...
LỜI CẢM ƠN \dotfill 1

NHẬN XÉT CỦA GIẢNG VIÊN \dotfill 2

MỤC LỤC \dotfill 3

A. HỢP ĐỒNG THÀNH LẬP NHÓM \dotfill 4

\quad Thời gian thành lập nhóm \dotfill 4

\quad Tên nhóm \dotfill 4

\quad Thành viên nhóm \dotfill 4

\quad Nguyên tắc làm việc nhóm \dotfill 4

\quad Không gian trao đổi và giao tiếp \dotfill 5

\quad Mục đích thành lập nhóm \dotfill 5

\quad Đánh giá công tác làm việc nhóm \dotfill 5

B. CÁC LINK MÀ NHÓM ĐÃ DÙNG \dotfill 6

C. GIỚI THIỆU VÀ HƯỚNG DẪN CHƠI GAME \dotfill 6

\quad Lời mở đầu và giới thiệu chung \dotfill 12

\quad Cài đặt và thiết lập \dotfill 14

Giao diện người dùng (UI) và điều khiển \dotfill

Cơ chế game play cốt lõi \dotfill

Hướng dẫn chơi theo tiến trình \dotfill

Mẹo nâng cao và những sai lầm cần tránh \dotfill

Lời kết và lời mời \dotfill
\newpage
% =========================
...
\subsection*{1. Khu vực Playfield (12 × 20)}
...
\subsection*{2. Hệ thống điều khiển}

Bạn có thể điều khiển khối Tetrimino bằng các phím sau:

Mũi tên trái/phải: di chuyển khối Tetrimino sang trái/phải

Mũi tên lên: xoay khối Tetrimino theo chiều kim đồng hồ.

Mũi tên xuống: tăng tốc rơi (soft drop).

Space: thả nhanh (hard drop).
